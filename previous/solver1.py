...
##                 activation_maps = activation.unsqueeze(1)
##                 os.makedirs('visualization', exist_ok = True)
##                 save_image(activation_maps, 'visualization/' + str(self.cnt) +'.png', normalize = True, nrow = row)
##                 self.cnt += 1
#			return hook
#
#		target_layers = [0,3,6,15,18,19,20,21]
...
#												   
		...
		for key in list(activation.keys()):
			temp = activation[key]
			data = temp.unsqueeze(1)
			save_image(data, str(key) + '.png', normalize = True, nrow = 8)
