...
if __name__ == '__main__':
	...
	image_a = opt.image_A
	image_b = opt.image_B
	os.makedirs('gradcam/apple/A2A/'+str(image_a[9:-3]), exist_ok = True)
	os.makedirs('gradcam/apple/A2B/'+str(image_a[9:-3]), exist_ok = True)
	os.system('rm -r ./datasets/apple2orange/apple2orange/trainA/*')
	os.system('rm -r ./datasets/apple2orange/apple2orange/trainB/*')
	os.system('cp ./datasets/apple2orange/apple2orange/trainA_real/' + str(image_a) + ' ./datasets/apple2orange/apple2orange/trainA/')
	os.system('cp ./datasets/apple2orange/apple2orange/trainB_real/' + str(image_b) + ' ./datasets/apple2orange/apple2orange/trainB/')
